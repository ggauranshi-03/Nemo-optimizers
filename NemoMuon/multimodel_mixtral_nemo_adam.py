...
#  ADAMW OPTIMIZER MODULE (REPLACEMENT)
...
def main():
    ...
    parser.add_argument("--name", type=str, default="multimodal_moe_adamw")
    ...
    optim = AdamWOptimizerModule(adam_w_lr=cfg.optim.adam_lr, weight_decay=cfg.optim.weight_decay)
